...
test_loader = DataLoader(test_dataset, batch_size=args.batch_size, shuffle=True,
                          num_workers=args.workers, pin_memory=True)
prefix = f'baseline_{currentTime}' if args.baseline else f'{currentTime}'
if args.baseline:
...
if args.eval:
    ...
    for epoch in range(120):
        ...
        if epoch in [20, 40, 60, 80, 100]:
            ...
            save_checkpoint(state_dict, filename=f'/data_b/lius/code/TestCaseCkps/{prefix}/checkpoint_{epoch}_{currentTime}.pth.tar')
